...
- Learn how to Create and User Agent Skills
- Learn How to Use Agent Skills with AI Agents
- Learn how to create Agent Skills with `bash`
- Learn how to create Agent Skills with `python script`
## How to Run
- Clone this repo
- Go to project root
- Open terminal
